...
this.start_date=new Date(dateTok[0],dateTok[1]-1,dateTok[2]);this.start_date_element.attr('value',this.start_date.getTime()/1000);
...
this.stop_date=new Date(dateTok[0],dateTok[1]-1,dateTok[2]);this.stop_date_element.attr('value',this.stop_date.getTime()/1000);
